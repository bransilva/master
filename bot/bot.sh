...
cd /usr/bin
wget https://raw.githubusercontent.com/bransilva/lucki756.v/refs/heads/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
...
wget https://raw.githubusercontent.com/bransilva/lucki756.v/refs/heads/main/bot/kyt.zip
unzip kyt.zip
